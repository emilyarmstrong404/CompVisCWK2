...
## to do :
## comments
## test other samples amount
## test set amount of patches per image instead of an overall maximum?
## fix txt file write - done
...
def buildVocab(trainPaths):
    numClusters = 700
    ## tried 100000, 50000, 25000, 10000
    ## 50000 would be roughly 30 patches per image
    ## should try the code but with a set amount of patches per image and not a random selection of patches over all the images
    maxSamples = 30000
    print(numClusters)
    print(maxSamples)
    allPatches = []
...
trainRoot = r"C:/Users/aemp1u25/OneDrive - University of Southampton/Documents/comp vis 2/training/training"
testRoot = r"C:/Users/aemp1u25/OneDrive - University of Southampton/Documents/comp vis 2/testing/testing"
...
## needs changing for the hand in so that max training size is used for hand in 
...
## writes to run2.txt 
outputPath = r"C:/Users/aemp1u25/OneDrive - University of Southampton/Documents/comp vis 2/run2.txt"
...
## comment out/delete before hand in 
...
trainAccuracy = computeAccuracy(trainLabelsSplit, trainPreds)
